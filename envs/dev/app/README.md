# envs/dev/app Python Documentation

## Overview

This package contains the FastAPI application for the development environment.
...
## Run Locally (dev package)

```bash
PYTHONPATH=envs/dev uvicorn app.main:app --host 0.0.0.0 --port 8443
```
