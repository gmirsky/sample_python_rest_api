# envs/qa/app Python Documentation

## Overview

This package contains the FastAPI application for the QA environment.
...
## Run Locally (qa package)

```bash
PYTHONPATH=envs/qa uvicorn app.main:app --host 0.0.0.0 --port 8443
```
