...
| Name | Type |
|------|------|
| [azurerm_container_registry.dev](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/container_registry) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_acr_name"></a> [acr\_name](#input\_acr\_name) | n/a | `string` | `"sample_dev_046948ed936a_acr"` | no |
